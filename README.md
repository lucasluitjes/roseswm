...
- bug: if there are 2 columns, and in the right column the bottom window is maximized, when you focus left and then right again, suddenly the top window has focus 
