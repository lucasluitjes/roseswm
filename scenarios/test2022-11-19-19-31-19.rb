...
scenario do
  ...
  $cmds << ["ps aux | grep int2",
   "paralle+   25587  0.0  0.0   2308   824 pts/0    S+   19:31   0:00 sh -c ps aux | grep int2\n" +
   "paralle+   25589  0.0  0.0   9016  1844 pts/0    R+   19:31   0:00 grep int2\n",
   0]
  ...
  $cmds << ["xwininfo -id 56644482",
   ...
   "  Map State: IsViewable\n" +
   "  Override Redirect State: no\n" +
   "  Corners:  +20+623  -578+623  -578-35  +20-35\n" +
   "  -geometry 132x27+20-35\n" +
   "\n",
   0]
  ...
  $cmds << ["xdotool windowmove 56623107 1370 430", "", 0]
  ...
  $cmds << ["xdotool windowmove 56629996 1370 814", "", 0]
  $cmds << ["wmctrl -ia 0x3600003", "", 0]
  ...
  assert_eq m.tags, [{:columns=>[["56629377", "56644482"], ["56638076", "56623107", "56629996"]],
    :old_columns=>[["56629377"], ["56638076", "56629996", "56623107"]],
    :column_sizes=>[{:x=>20, :w=>1330}, {:x=>1370, :w=>530}],
    :fullscreen=>nil,
    :column_maximized=>[nil, nil]},
...
scenario do
  m = Manager.new('')
  m.current_tag = 0
  m.tags =   [{:columns=>[["56629377", "56644482"], ["56638076", "56623107", "56629996"]],
    :old_columns=>[["56629377"], ["56638076", "56629996", "56623107"]],
    :column_sizes=>[{:x=>20, :w=>1330}, {:x=>1370, :w=>530}],
    :fullscreen=>nil,
    :column_maximized=>[nil, nil]},
  ...
  $cmds << ["xrandr",
   ...
   0]
  $cmds << ["ps aux | grep int2",
   "paralle+   25648  0.0  0.0   2308   836 pts/0    S+   19:31   0:00 sh -c ps aux | grep int2\n" +
   "paralle+   25650  0.0  0.0   9016  1844 pts/0    R+   19:31   0:00 grep int2\n",
   0]
  $cmds << ["wmctrl -ia 0x3601881", "", 0]
  $cmds << ["wmctrl -ia 0x3605382", "", 0]
  $cmds << ["wmctrl -ia 0x3603a7c", "", 0]
